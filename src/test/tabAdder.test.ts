...
describe("Add tab object to items object when pressing on the addTab button ", () => {

});


describe("Remove tab object from items object when pressing on delete (x) button", () => {
